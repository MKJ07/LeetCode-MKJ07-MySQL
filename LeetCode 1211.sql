...
Query:
      ...
      round((select count(*) from Queries q2 where q2.rating<3 and q1.query_name=q2.query_name)/count(q1.query_name)*100,2) as poor_query_percentage from Queries q1
